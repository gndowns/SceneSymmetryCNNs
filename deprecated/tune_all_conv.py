# Fine Tune all conv layers of VGG16
...
def train(model, dataset):
  ...
  filepath = dataset.string + '_all_conv_weights.h5'
...
def main():
  ...
  model.load_weights(dataset_str + '_all_conv_weights.h5')
  print('saving model...')
  model.save(dataset_str + '_all_conv.h5')
  print('done!')
